...
const RegistrationView: React.FC<RegistrationViewProps> = ({ onBack, onSignUp }) => {
  ...
  return (
    <div className="bg-white min-h-screen px-6 py-8 flex flex-col">
      {/* Bouton Retour */}
      <div className="mb-10">
        <button
          onClick={onBack}
      ...
      {/* Titres */}
      <div className="mb-10">
        <h1 className="text-4xl font-extrabold text-[#1D1D4B] mb-3">Rejoignez-nous</h1>
      ...
      <div className="flex-1 space-y-6">
        ...
        <div className="space-y-2">
          <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest ml-1">CONFIRMER MOT DE PASSE</label>
          <div className="bg-gray-50 rounded-2xl px-5 py-4 flex items-center gap-4 focus-within:ring-2 focus-within:ring-[#1D1D4B]/5 transition-all">
            <Lock size={20} className="text-gray-400" />
            <input
